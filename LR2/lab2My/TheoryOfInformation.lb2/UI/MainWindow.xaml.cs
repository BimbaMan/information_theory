...
namespace TheoryOfInformation.lb2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void TB_PerformFileNameChange(object sender, TextChangedEventArgs e)
        {
            ...
            BT_Perform.IsEnabled = (!TB_PerformFileName.Text.Equals(String.Empty) && !TB_ResultFileName.Text.Equals("") && TB_initialKey.Text.Length == 32 && zeroCheck(TB_initialKey.Text));
        }
        ...
        private void BT_Perform_Click(object sender, RoutedEventArgs e)
        {
            ...
            Encoder.Encode(new int[] {32, 28, 27, 1}, TB_initialKey.Text, TB_PerformFileName.Text, TB_ResultFileName.Text, 
